defmodule OpenAperture.ManagerApi.ProductEnvironment.Test do
  ...
  test "list environments", context do
    use_cassette "products/product_environment/list_environments", custom: true do
      response = OpenAperture.ManagerApi.ProductEnvironment.list(context[:api], "jordans_test_product")
  ...
  test "get environment", context do
    use_cassette "products/product_environment/get_environment", custom: true do
      response = OpenAperture.ManagerApi.ProductEnvironment.get_environment(context[:api], "jordans_test_product", "testing")
      assert response.status == 200
  ...
  test "create environment", context do
    use_cassette "products/product_environment/create_environment", custom: true do
      ...
      response = OpenAperture.ManagerApi.ProductEnvironment.create_environment(context[:api], "jordans_test_product", environment)
  ...
  test "update environment", context do
    use_cassette "products/product_environment/update_environment", custom: true do
      ...
      response = OpenAperture.ManagerApi.ProductEnvironment.update_environment(context[:api], "jordans_test_product", "new_test_environment", updated_environment)
  ...
  test "delete_environment", context do
    use_cassette "products/product_environment/delete_environment", custom: true do
      response = OpenAperture.ManagerApi.ProductEnvironment.delete_environment(context[:api], "jordans_test_product", "updated_test_environment")
      assert response.status == 204
    end
  end
